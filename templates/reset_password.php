	...
	<div class="form-wrapper">
		<div class="form-container">
			...
			<form action="reset_password.php" class="form-box" method="post">
				<div class="mb-3">
					<input type="password" class="form-control" id="password" name="password" autocomplete="off" placeholder="New Password" require title="Must contain at least one number, upper- and lowercase letter, special character and be at least 8 characters long">
				...
				<div class="mb-3">
					<input type="password" id="confirmation" class="form-control" name="confirmation" autocomplete=off" placeholder="Confirm password" require>
